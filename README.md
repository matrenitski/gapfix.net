...
4. GapFix shows any UTXOs hidden beyond the gap and generates a copy-paste dust address list.
5. **Send dust** to those addresses using your wallet.
6. **Rescan** your wallet — the hidden funds should now appear.
